...
class PathManager:
    ...
    def __init__(self, base_dir: Optional[Path] = None):
        ...
        Args:
            base_dir: Base directory (default: edge-agent directory)
        """
        if base_dir is None:
            # Get the edge-agent directory (parent of agent package)
    ...
    def get_log_db_path(self, device_id: str) -> Path:
        """Get path to log database for device."""
    ...
    def get_model_path(self, model_name: str, device_id: Optional[str] = None) -> Path:
        ...
        Args:
            ...
            device_id: Optional device ID for device-specific models
