...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("Usage:")
        print("  python -m edgepulse.windows_service install [python_exe]")
        print("  python -m edgepulse.windows_service uninstall")
        print("  python -m edgepulse.windows_service start")
        print("  python -m edgepulse.windows_service stop")
        print("  python -m edgepulse.windows_service status")
        print("  python -m edgepulse.windows_service logs [lines]")
        print("  python -m edgepulse.windows_service cleanup")
        sys.exit(1)
