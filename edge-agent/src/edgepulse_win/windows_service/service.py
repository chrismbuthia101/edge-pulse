...
class EdgePulseWindowsService(win32service.ServiceFramework):
    ...
    def __init__(self, service_name: str, service_display_name: str, 
                 service_description: str, agent_wrapper):
    ...
    def SvcStop(self):
        ...
        try:
            ...
            if self._agent_wrapper and self._agent_wrapper.agent_core:
                # Create event loop in thread to stop agent
                def stop_agent():
...
# Service registration for Windows Service framework
if sys.platform == "Windows":
    # This allows service to be properly registered with Windows
