...
from edgepulse_win.detectors.model_integrity import ModelIntegrityVerifier  # fixed: was detectorsmodel_integrity
...
class ModelManager:
    ...
    def __init__(self, config_manager: ConfigManager, path_manager: Optional[PathManager] = None):
    ...
    async def _load_model_config(self):
        ...
        try:
            ...
            logger.info(
                f"Loaded model config: {self.current_model_type}, threshold: {self.detection_threshold}"
            )
        ...
        try:
            ...
            if success:
                ...
                if save_success:
                    ...
                    self.config_manager.set("model.detection_threshold", self.detection_threshold)
    ...
    async def set_detection_threshold(self, threshold: float) -> bool:
        ...
        try:
            if 0.0 <= threshold <= 1.0:
                ...
                self.config_manager.set("model.detection_threshold", threshold)
    ...
    def get_training_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "current_model_trained": (
                self.current_detector.is_trained if self.current_detector else False
            ),
        }