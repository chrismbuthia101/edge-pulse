          ...
          <div className="absolute top-24 left-12 right-12 bottom-24 flex items-center justify-center">
            <div className="relative flex flex-col items-center text-center max-w-sm px-8">
              ...
              <div className="relative mb-8">
                ...
                {[
                  ...
                  <motion.div
                    ...
                    style={{
                      right: dot.x < 0 ? undefined : -dot.x,
                      left: dot.x < 0 ? -dot.x : undefined,
                      top: dot.y,
                    }}
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                We&apos;ll send a secure link to your email address. The link
                expires after 1 hour for your safety.
              </p>
                ...
                {!submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          <Mail
                            className={`absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 transition-colors duration-200 ${focusedField ? "text-primary" : "text-muted-foreground"}`}
                          />
                          <Input
                            id="email"
                            type="email"
                        ...
                        <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg px-3 py-2">
                          <p className="text-xs text-blue-700 dark:text-blue-300">
                            If an account with this email exists, we&apos;ll
                  ...
                  >
                    ...
                    <div className="bg-muted/50 border border-border rounded-xl px-5 py-4 text-sm text-muted-foreground text-left mb-6 space-y-1.5">
                      <p className="font-medium text-foreground text-xs uppercase tracking-widest mb-2">
                        What to do next
                      </p>
