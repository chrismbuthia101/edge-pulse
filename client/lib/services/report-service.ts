import { ReportRepository, type ReportMetrics, type ReportQueryOptions } from '@/lib/repositories/report-repository';
...
export class ReportService {
  ...
  async getReportMetrics(options: GetReportOptions = {}): Promise<ReportMetrics> {
  ...
  async generateReport(options: GenerateReportOptions): Promise<{ url: string }> {
