...
export function AdminSidebar({
  ...
  return (
    <>
      ...
      >
        <div className="h-16 flex items-center px-4 border-b border-border dark:border-white/10 shrink-0">
          {collapsed ? (
            <Link
              href="/admin/overview"
        ...
        <div className="border-t border-border dark:border-white/10 py-3 px-2 space-y-1">
          <button
