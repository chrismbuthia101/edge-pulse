...
export function ModelPerformance() {
  ...
  const metrics = useMemo(() => {
    ...
    const falsePositiveRate =
      totalAlerts > 0 ? ((totalAlerts - closedAlerts) / totalAlerts) * 100 : 0;
    ...
    <div className="bg-card border border-border rounded-2xl overflow-hidden">
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            <div
              className={`text-2xl font-bold font-display ${hasData ? "text-green-500" : "text-muted-foreground"}`}
            >
          ...
          >
            <div
              className={`text-2xl font-bold font-display ${hasData ? "text-primary" : "text-muted-foreground"}`}
            >
          ...
          >
            <div
              className={`text-2xl font-bold font-display ${hasData ? "text-amber-500" : "text-muted-foreground"}`}
            >
          ...
          >
            <div
              className={`text-2xl font-bold font-display ${hasData ? "text-violet-500" : "text-muted-foreground"}`}
            >
        ...
        <div className="space-y-4">
          ...
          {!hasData ? (
            <div className="text-center py-4 text-muted-foreground">
              ...
              <p className="text-xs">
                Metrics will appear when alerts are detected
              </p>
            </div>
          ) : (
