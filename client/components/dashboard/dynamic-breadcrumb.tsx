...
const DYNAMIC_ROUTES: Record<string, (params: string[]) => { label: string; href: string }[]> = {
    "/dashboard/devices/": (params) => [
        { label: "Devices", href: "/dashboard/devices" },
        { label: params[0] || "Unknown Device", href: `/dashboard/devices/${params[0]}` },
    ],
};
...
export function DynamicBreadcrumb() {
    ...
    const generateBreadcrumbs = () => {
        ...
        return breadcrumbs.length > 0 ? breadcrumbs : [{ label: "Dashboard", href: "/dashboard" }];
    };
