        ...
        <div className="bg-card border border-border rounded-2xl overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b border-border">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-semibold text-foreground">SHAP Explainability</h3>
                </div>
                <div className="flex items-center gap-1.5">
                    <span className="text-xs text-muted-foreground">dev-laptop-07</span>
            ...
            <div className="px-5 py-4">
                {/* Score summary */}
                <div className="flex items-center gap-4 mb-5 p-3 bg-destructive/8 border border-destructive/15 rounded-xl">
                    <div>
                        <p className="text-xs text-muted-foreground mb-0.5">Anomaly Score</p>
                        <p className="text-2xl font-bold font-mono text-destructive">0.97</p>
                    </div>
                    ...
                    {features.map((feat, i) => {
                        ...
                        return (
                            <div key={feat.label} className="flex items-center gap-3">
                                <p className="text-xs text-muted-foreground w-36 shrink-0 truncate" title={feat.label}>
                                    {feat.label}
                                </p>
                                <div className="flex-1 flex items-center gap-2">
                                    ...
                                    <span
                                        className={`text-xs font-mono font-bold w-10 text-right ${feat.positive ? "text-destructive" : "text-primary"
                                            }`}
                                    >
                                        {feat.raw}
                                    </span>
