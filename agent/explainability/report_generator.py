    ...
    def format_as_html(self, report: Dict) -> str:
        ...
        <head>
            ...
            <style>
                ...
                .factor {{ margin: 10px 0; padding: 10px; background-color: #f8f9fa; border-radius: 3px; }}
                .action {{ margin: 5px 0; padding: 5px; }}
            </style>
        </head>
        <body>
            <div class="header">
                ...
                <p>Severity: <strong>{report['severity'].upper()}</strong></p>
            </div>
            
            <div class="section">
                <h2>Anomaly Details</h2>
                <p><strong>Score:</strong> {report['anomaly_score']:.4f}</p>
                <p><strong>Type:</strong> {report['anomaly_type']}</p>
            </div>
        ...
        for factor in report['explanation']['contributing_factors']:
            html += f"""
                <div class="factor">
                    ...
                    Contribution: {factor['contribution']:.4f} ({factor['direction']})
                </div>
            """
